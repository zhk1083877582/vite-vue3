<template>
  ...
  <el-menu active-text-color="#ffd04b" background-color="#1a202e" text-color="#fff" :default-active="current"
    :default-openeds="opens" :unique-opened="true" class="el-menu-vertical-demo" popper-class="custom-menu-popper"
    :style="{
      maxWidth: '200px',
      overflowY: 'auto',
