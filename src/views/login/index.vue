	...
	<div class="login-container">
		<div class="login-box">
			<div class="login-header">
				...
				<h1>非车理赔系统</h1>
				<p class="subtitle">Property Insurance Claims Management System</p>
			</div>
			...
			<div class="login-form">
				<el-form ref="formRef" :model="formState" :rules="ruleValidate">
					...
					<el-form-item prop="password">
						<el-input v-model="formState.password" :type="isShowPassWord ? 'text' : 'password'" size="large" placeholder="密码">
							<template #append>
					...
					<el-form-item>
						<el-button style="width: 100%" type="primary" size="large" :loading="loading" @click="handleSubmit">
							{{ loading ? "登录中..." : "登录" }}
						</el-button>
					</el-form-item>
				</el-form>
			...
			<div class="login-footer">
				<p>© {{ new Date().getFullYear() }} 保险公司. All Rights Reserved.</p>
			</div>
		</div>
	</div>
</template>
